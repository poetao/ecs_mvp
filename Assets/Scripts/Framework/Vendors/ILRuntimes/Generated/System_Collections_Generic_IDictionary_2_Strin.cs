...
{
    unsafe class System_Collections_Generic_IDictionary_2_String_ISubject_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.IDictionary<System.String, UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>>);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ContainsKey", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ContainsKey_0);
            args = new Type[]{typeof(System.String), typeof(UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>)};
            ...
            args = new Type[]{typeof(System.String), typeof(UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>).MakeByRefType()};
        ...
        static StackObject* ContainsKey_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.IDictionary<System.String, UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>> instance_of_this_method = (System.Collections.Generic.IDictionary<System.String, UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>>)typeof(System.Collections.Generic.IDictionary<System.String, UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* set_Item_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance> @value = (UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance> @value = (UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as UniRx.ISubject<ILRuntime.Runtime.Intepreter.ILTypeInstance>[];
