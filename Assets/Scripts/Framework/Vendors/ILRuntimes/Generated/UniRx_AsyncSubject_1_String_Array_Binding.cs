...
{
    unsafe class UniRx_AsyncSubject_1_String_Array_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UniRx.AsyncSubject<System.String[]>);
            args = new Type[]{};
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UniRx.AsyncSubject<System.String[]> instance_of_this_method = (UniRx.AsyncSubject<System.String[]>)typeof(UniRx.AsyncSubject<System.String[]>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
